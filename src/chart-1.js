...
const margin = { top: 90, left: 60, right: 60, bottom: 100 }
...
var forceYCombine = d3.forceY(width / 2).strength(0.05)

var forceCollide = d3.forceCollide(16)
...
function ready(datapoints) {
  ...
  var circles = svg
    ...
    .on('mouseover', function(d) {
      ...
      d3.select('#pageviews2').text(d.TotalPageViews)
